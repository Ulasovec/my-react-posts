...
function Posts() {
    ...
    const addPost = (newPost) => {
        ...
        setModal(false);
        axios.post('http://localhost:1337/api/posts', { data: newPost});
    };
    ...
    return (
        <div className="App">
            ...
            <Fetch
                uri={'http://localhost:1337/api/posts'}
                renderSuccess={data => <PostList posts={data.data} deletePost={deletePost}/>}
            />
            ...
            />
            {/*<img src="http://localhost:1337/uploads/Mit_5_edd837e95a.jpg"/>*/}
        </div>
    );
}
